    ...
    <div class="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">
        <div class="p-8">
            <div class="text-center mb-8">
                ...
                <p class="mt-2 text-sm text-gray-600">Please rate your experience for Complaint #{{ $complaint->id }}</p>
            </div>
            ...
            @elseif(!session('success'))
                <div class="mb-6 bg-blue-50 p-4 rounded-lg">
                    ...
                    <p class="text-sm text-blue-800"><span class="font-medium">Category:</span> {{ ucfirst($complaint->category) }}</p>
                    <p class="text-sm text-blue-800"><span class="font-medium">Assigned To:</span> {{ $complaint->assignedEmployee->name ?? 'Unassigned' }}</p>
                </div>
                ...
                <form action="{{ route('frontend.feedback.submit', $complaint->id) }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <label class="cursor-pointer">
                                ...
                                <div class="p-4 rounded-lg border-2 border-gray-200 peer-checked:border-green-500 peer-checked:bg-green-50 hover:bg-gray-50 transition-all text-center">
                            ...
                            <label class="cursor-pointer">
                                ...
                                <div class="p-4 rounded-lg border-2 border-gray-200 peer-checked:border-blue-500 peer-checked:bg-blue-50 hover:bg-gray-50 transition-all text-center">
                                    <div class="text-2xl mb-1">🙂</div>
                            ...
                            <label class="cursor-pointer">
                                ...
                                <div class="p-4 rounded-lg border-2 border-gray-200 peer-checked:border-yellow-500 peer-checked:bg-yellow-50 hover:bg-gray-50 transition-all text-center">
                                    <div class="text-2xl mb-1">😐</div>
                            ...
                            <label class="cursor-pointer">
                                ...
                                <div class="p-4 rounded-lg border-2 border-gray-200 peer-checked:border-red-500 peer-checked:bg-red-50 hover:bg-gray-50 transition-all text-center">
                                    <div class="text-2xl mb-1">😞</div>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="comments" name="comments" rows="3" class="shadow-sm focus:ring-blue-500 focus:border-blue-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md p-2" placeholder="Any additional feedback..."></textarea>
                        @error('comments')
                            <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                        @enderror
                    </div>
