                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('phone') is-invalid @enderror" 
                                           id="phone" name="phone" value="{{ old('phone', $employee->user->phone) }}">
                                    @error('phone')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('theme') is-invalid @enderror" 
                                            id="theme" name="theme">
                                        <option value="light" {{ old('theme', $employee->user->theme) == 'light' ? 'selected' : '' }}>Light</option>
                                        <option value="dark" {{ old('theme', $employee->user->theme) == 'dark' ? 'selected' : '' }}>Dark</option>
                                        <option value="night" {{ old('theme', $employee->user->theme) == 'night' ? 'selected' : '' }}>Night</option>
                                    </select>
                                    @error('theme')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
