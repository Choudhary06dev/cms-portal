...
@section('content')
    ...
    <div class="card-glass mb-4">
        <form method="GET" action="{{ route('admin.spares.index') }}">
            <div class="row g-3">
                <div class="col-md-4">
                    <input type="text" class="form-control" name="search" placeholder="Search spares..."
                        value="{{ request('search') }}">
                </div>
                <div class="col-md-3">
                    <select class="form-select" name="category">
                        <option value="">All Categories</option>
                        <option value="electrical" {{ request('category') == 'electrical' ? 'selected' : '' }}>Electrical
                        </option>
                        ...
                        <option value="consumables" {{ request('category') == 'consumables' ? 'selected' : '' }}>Consumables
                        </option>
                    </select>
                </div>
                <div class="col-md-3">
                ...
                <div class="modal-body" id="modalBody">
                    <form id="spareForm" method="POST" autocomplete="off" novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="threshold_level" class="form-label">Threshold Level <span
                                        class="text-danger">*</span></label>
                                <input type="number" class="form-control" id="threshold_level" name="threshold_level"
                                    min="0" required autocomplete="off">
                                <div class="invalid-feedback"></div>
                            </div>
