      ...
      <div class="info-item mb-3">
        <div class="d-flex align-items-start">
          ...
          <div class="flex-grow-1">
            ...
            <div class="text-white" style="font-size: 0.95rem; font-weight: 500;" data-item-name="{{ $spare->item_name }}">{{ $spare->item_name ?? 'N/A' }}</div>
          </div>
        </div>
      </div>
...
<div class="row mb-4" id="stockHistorySection">
  <div class="col-12">
    <div class="card-glass">
      <div class="d-flex align-items-center justify-content-between mb-4" style="border-bottom: 2px solid rgba(59, 130, 246, 0.2); padding-bottom: 12px;">
        ...
        <button type="button" class="btn btn-outline-primary btn-sm" id="refreshHistoryBtn" onclick="window.loadStockHistory({{ $spare->id }})" title="Refresh History">
