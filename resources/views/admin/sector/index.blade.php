...
<div class="card-glass">
  ...
  <div class="card-body">
    ...
    <!-- TOTAL RECORDS -->
    <div id="sectorsTableFooter" class="text-center py-2 mt-2" style="background-color: rgba(59, 130, 246, 0.2); border-top: 2px solid #3b82f6; border-radius: 0 0 8px 8px;">
