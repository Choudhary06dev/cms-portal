  ...
  <div class="card-body">
    <div class="table-responsive">
      <table class="table  align-middle compact-table">
            ...
            <td>
              <div class="d-flex gap-2">
                <button type="button" class="btn btn-sm btn-outline-light" data-bs-toggle="modal" data-bs-target="#editSectorModal" 
                        data-id="{{ $sector->id }}" data-name="{{ $sector->name }}" data-status="{{ $sector->status }}" data-description="{{ $sector->description }}">
                  Edit
                </button>
        ...
        @empty
          <tr>
            <td colspan="4" class="text-center text-muted">No sectors yet.</td>
          </tr>
        @endforelse
        </tbody>
      </table>
